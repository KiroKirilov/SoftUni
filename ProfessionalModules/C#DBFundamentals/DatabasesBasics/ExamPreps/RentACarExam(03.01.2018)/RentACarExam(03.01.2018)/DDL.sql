...
(
	...
	CONSTRAINT FK_Orders_Offices_Collection FOREIGN KEY (CollectionOfficeId) REFERENCES Offices(Id),
	CONSTRAINT FK_Orders_Offices_Return FOREIGN KEY (ReturnOfficeId) REFERENCES Offices(Id)
)